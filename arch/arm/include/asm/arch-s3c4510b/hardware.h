...
/* 4 x 16KB I/O base address */
#define IO_BASE		(0x03600000)
#define IO_BANK(x)	(IO_BASE + (0x4000 * (x)))
...
/*********************************************************/
#define	I2CCON_BF			(1 << 0)	/* Buffer flag */
#define	I2CCON_IEN			(1 << 1)	/* Interrupt enable */
#define	I2CCON_LRB			(1 << 2)	/* Last received bit */
#define	I2CCON_ACK			(1 << 3)	/* Acknowledge enable */
#define	I2CCON_COND_START		(1 << 4)	/* Generate START condition */
#define	I2CCON_COND_STOP		(2 << 4)	/* Generate STOP condition */
#define	I2CCON_COND_REPEAT_START	(3 << 4)	/* Generate REPEATED START condition */
#define	I2CCON_BUSY			(1 << 6)	/* Bus busy */
#define	I2CCON_RESET			(1 << 7)	/* Reset */

#define	I2CPS_100K			(31)		/* Prescaler value for 100kHz */
